        ...
        <Layout>
            <div className='relative w-full h-100 mt-60' >
                <div className="w-5/6 mx-auto">
                    <div className="w-full mx-auto flex md:flex-row flex-col justify-between items-center py-5">
                        <div className='flex flex-col md:items-start items-center p-6'>
                            <div className='font-bold text-colorPink'>Our Gallery</div>
                            <div className='font-bold text-colorPurple text-4xl md:text-start text-center'>Check out the collection pictures from our clinic</div>
                        </div>
                        <div className='text-colorGray h-full px-6 text-center sm:text-start md:w-7/12 w-full text-2xl'>
            ...
            <div className="w-full md:flex-row flex md:justify-between flex-col items-center mx-auto px-28 pb-28 sm:bg-[length:54%_100%] bg-[length:80%_100%]" style={{backgroundImage: `url(${bgGallery1})`, backgroundPosition: 'right', backgroundRepeat: 'no-repeat'}}>
                <div className='sm:w-2/4 w-full pt-10'>
                    <div className='text-colorPink font-bold'>Get the Qouta</div>
                    <div className='text-colorPurple text-3xl font-bold my-3 sm:w-auto w-full'>Want to be handled by our professional team immediately?</div>
